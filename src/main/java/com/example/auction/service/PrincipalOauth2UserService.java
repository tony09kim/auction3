...
import com.example.auction.oauth2.GoogleUserInfo;
import com.example.auction.oauth2.KakaoUserInfo;
import com.example.auction.oauth2.NaverUserInfo;
import com.example.auction.oauth2.OAuth2UserInfo;
...
public class PrincipalOauth2UserService extends DefaultOAuth2UserService {
    ...
    private OAuth2User processOAuth2User(OAuth2UserRequest userRequest,
        ...
        ProductController.testOwnerId= Math.toIntExact(user.getUserId());
        log.info(String.valueOf(ProductController.testOwnerId));
